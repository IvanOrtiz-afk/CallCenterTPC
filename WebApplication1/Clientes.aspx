                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-2 mb-md-0">
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control" placeholder="Buscar por nombre, documento o email..."></asp:TextBox>
                    ...
                    <div class="col-md-6 text-md-end">
                        <asp:CheckBox ID="chkVerInactivos" runat="server" Text=" Mostrar clientes inactivos" AutoPostBack="true" OnCheckedChanged="chkVerInactivos_CheckedChanged" CssClass="form-check-input me-2" />
                    </div>
                </div>
            </div>
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        <ItemTemplate>
                            ...
                            <button type="button"
                                ...
                                data-id='<%# Eval("id") %>'
                                data-mensaje='<%# Convert.ToBoolean(Eval("activo")) ? "¿Confirmás que querés dar de baja a este cliente?" : "¿Confirmás que querés reactivar a este cliente?" %>'>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p id="lblModalTexto">¿Confirmás que querés cambiar el estado de este cliente?</p>
                </div>

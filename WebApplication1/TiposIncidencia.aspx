    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-body p-0"> <asp:GridView ID="dgvTiposIncidencia" runat="server" CssClass="table table-striped table-hover mb-0" 
                        AutoGenerateColumns="False" GridLines="None" EmptyDataText="No hay tipos de incidencia registrados.">
